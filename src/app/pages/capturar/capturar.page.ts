...
export class CapturarPage implements OnInit {
  ...
  domicilioGeografico!: DomicilioGeografico; //= new DomicilioGeografico;
  ...
  getNombresVialidades(cve_ent_param: string, cve_mun_param: string, cve_loc_param: string, cve_tipo_vialidad_param: string) {
    ...
    this.getServices.getNombresVialidades(cve_ent_param, cve_mun_param, cve_loc_param, cve_tipo_vialidad_param);
    this.getServices.allNombresVialidades$.subscribe((nombresVialidades) => {
  ...
  onKeyDown(event: KeyboardEvent, param: string) {
    switch (param) {
      case 'nom_tipo_vialidad': this.formularioCapturar.get('nom_nombre_vialidad')?.setValue('');
                                this.filteredNombresVialidades = [];
                                break;
      case 'nom_tipo_asentamiento': this.formularioCapturar.get('nom_nombre_asentamiento')?.setValue('');
                                this.filteredNombresAsentamientos = [];
                                break;
      case 'nom_tipo_vialidad_referencia1': this.formularioCapturar.get('nom_nombre_vialidad_referencia1')?.setValue('');
                                this.filteredNombresVialidadesReferencia1 = [];
                                break;
      case 'nom_tipo_vialidad_referencia2': this.formularioCapturar.get('nom_nombre_vialidad_referencia2')?.setValue('');
                                this.filteredNombresVialidadesReferencia2 = [];
                                break;
      case 'nom_tipo_vialidad_posterior': this.formularioCapturar.get('nom_nombre_vialidad_posterior')?.setValue('');
  ...
  submitForm() {
    this.domicilioGeografico.id = this.titulo === 'capturar' ? Utils.generaIdUnico(): this.idEdicion;
    //captura con select o desde teclado
    console.log('this.domicilioGeografico.nom_ent->', this.domicilioGeografico.nom_ent);
    console.log('this.formularioCapturar.value.nom_ent->', this.formularioCapturar.value.nom_ent);
    ...
    console.log('this.domicilioGeografico.nom_mun->', this.domicilioGeografico.nom_mun);
    console.log('this.formularioCapturar.value.nom_mun->', this.formularioCapturar.value.nom_mun);
    if (this.domicilioGeografico.nom_mun !== this.formularioCapturar.value.nom_mun) {
      this.domicilioGeografico.cve_mun = '000';
      this.domicilioGeografico.nom_mun = this.formularioCapturar.value.nom_mun;
    }
    console.log('this.domicilioGeografico.nom_loc->', this.domicilioGeografico.nom_loc);
    console.log('this.formularioCapturar.value.nom_loc->', this.formularioCapturar.value.nom_loc);
    if (this.domicilioGeografico.nom_loc !== this.formularioCapturar.value.nom_loc) {
      this.domicilioGeografico.cve_loc = '0000';
      this.domicilioGeografico.nom_loc = this.formularioCapturar.value.nom_loc;
    }
    console.log('this.domicilioGeografico.nom_tipo_vialidad->', this.domicilioGeografico.nom_tipo_vialidad);
    console.log('this.formularioCapturar.value.nom_tipo_vialidad->', this.formularioCapturar.value.nom_tipo_vialidad);
    ...
    console.log('this.domicilioGeografico.nom_nombre_vialidad->', this.domicilioGeografico.nom_nombre_vialidad);
    console.log('this.formularioCapturar.value.nom_nombre_vialidad->', this.formularioCapturar.value.nom_nombre_vialidad);
    ...
    console.log('this.domicilioGeografico.nom_tipo_asentamiento->', this.domicilioGeografico.nom_tipo_asentamiento);
    console.log('this.formularioCapturar.value.nom_tipo_asentamiento->', this.formularioCapturar.value.nom_tipo_asentamiento);
    ...
    console.log('this.domicilioGeografico.nom_nombre_asentamiento->', this.domicilioGeografico.nom_nombre_asentamiento);
    console.log('this.formularioCapturar.value.nom_nombre_asentamiento->', this.formularioCapturar.value.nom_nombre_asentamiento);
    ...
    console.log('this.domicilioGeografico.nom_tipo_vialidad_referencia1->', this.domicilioGeografico.nom_tipo_vialidad_referencia1);
    console.log('this.formularioCapturar.value.nom_tipo_vialidad_referencia1->', this.formularioCapturar.value.nom_tipo_vialidad_referencia1);
    ...
    console.log('this.domicilioGeografico.nom_nombre_vialidad_referencia1->', this.domicilioGeografico.nom_nombre_vialidad_referencia1);
    console.log('this.formularioCapturar.value.nom_nombre_vialidad_referencia1->', this.formularioCapturar.value.nom_nombre_vialidad_referencia1);
    ...
    console.log('this.domicilioGeografico.nom_tipo_vialidad_referencia2->', this.domicilioGeografico.nom_tipo_vialidad_referencia2);
    console.log('this.formularioCapturar.value.nom_tipo_vialidad_referencia2->', this.formularioCapturar.value.nom_tipo_vialidad_referencia2);
    ...
    console.log('this.domicilioGeografico.nom_nombre_vialidad_referencia2->', this.domicilioGeografico.nom_nombre_vialidad_referencia2);
    console.log('this.formularioCapturar.value.nom_nombre_vialidad_referencia2->', this.formularioCapturar.value.nom_nombre_vialidad_referencia2);
    ...
    console.log('this.domicilioGeografico.nom_tipo_vialidad_posterior->', this.domicilioGeografico.nom_tipo_vialidad_posterior);
    console.log('this.formularioCapturar.value.nom_tipo_vialidad_posterior->', this.formularioCapturar.value.nom_tipo_vialidad_posterior);
    ...
    console.log('this.domicilioGeografico.nom_nombre_vialidad_posterior->', this.domicilioGeografico.nom_nombre_vialidad_posterior);
    console.log('this.formularioCapturar.value.nom_nombre_vialidad_posterior->', this.formularioCapturar.value.nom_nombre_vialidad_posterior);
    ...
    console.log('this.domicilioGeografico=>', this.domicilioGeografico);
    if (this.formularioCapturar.invalid) {
      ...
      if (this.titulo === environment.tituloCapturar) {
        console.log('capturar domicilio geográfico');
        this.servicioCapturar();
      }
      if (this.titulo === environment.tituloEditar) {
        console.log('editar domicilio geográfico');
        this.servicioEditar();
      }
    }
  }
